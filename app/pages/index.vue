      ...
      <div class=" narrow x c rel"  style="top: 0;z-index: 3;">
        <div class="v z rel" style="padding: 0em 0 4em; ">
          <div class="w100 rel">
            ...
            <div style="transform: rotate(0) translate(0, 440px) scale(0.8); left: 0;position: absolute;">
              <div id="" class=" rdx pt20 pb20  rate-tab" style="left: 400px">
                <div class="">
                  <h2 class="ml20 f17 w6">Please select the best picture below</h2>
                  <div class=" bg-white gp50 gg0">
                    <img src="assets/clevelan.jpg" class="mat w100 v">
                    <img src="assets/mckinley.jpg" class="mat w100 v">
                  </div>
                  <div class="  bsbx ">
                    <div class="panel-mobile-inner">
                      <div class="note-section iS mt32 pl20 pr20">
                        <div class="note-section-headline w6 f12"><span class="leave-a-note">Leave a note (optional)</span></div>
                        <textarea placeholder="This picture seems ..." id="txa" tabindex="-1" maxlength="255" class="w100 form-control note-box note-box-mobile js-note-box"></textarea>
                        <div class="tap-block"></div>
                        <div class="to-note-step"></div>
                      </div>
                      <div class="quick-notes clearfix in-panel mt32 pl20 pr20">
                        <div class="gp50 gg20 y z mt48 w100">
                          <button class="pointer ml32 btn alt lh20 w6 f13 submit-button">Skip</button>
                          <button class="pointer ml32 btn blue lh20 w6 f13 submit-button">Submit</button>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div id="" class=" rdx pt20 pb20  rate-tab" style="left: 400px;top:590px">
                <div class="">
                  <h2 class="ml20 f17 w6">Please select the best picture below</h2>
                  <div class="bg-white gp50 gg0">
                    <img src="assets/cam1.jpg" class="mat w100 v">
                    <img src="assets/cam2.jpg" class="mat w100 v">
                  </div>
                  <div class="  bsbx ">
                    <div class="panel-mobile-inner">
                      <div class="note-section iS mt32 pl20 pr20">
              ...
              <div id="" class=" rdx pt20 pb20  rate-tab" style="left: 0;top: -80px">
                <div class="">
                  <h2 class="ml20 f17 w6">Please rate the image below</h2>
                  <div class=" bg-white">
                    <img src="assets/b@2x.jpg" class="mat mt30 mb30 w100 v">
                  </div>
                  <div class="  bsbx ">
                    <div class="panel-mobile-inner">
                      <div class="score-row score-row-traits clearfix pl20 pr20">
                        <div class="score-column smart y z">
                          <span class="trait-name w6 f15 no-select">Artistry</span>
                          <div class="smart y w120p">
                            <span class="f11 lh24 w5 mr12" id="composition-val">5.00</span>
                            <input type="range" min="0" max="1000" value="500"  class="meter mla"  id="composition-meter"/>
                          </div>
                        </div>
                        <div class="score-column smart y z mt16">
                          <div class="trait-name w6 f15 no-select">Coloration</div>
                          <div class="smart y w120p">
                            <span class="f11 lh24 w5 mr12" id="subject-val">5.00</span>
                            <input type="range" min="0" max="1000" value="500"  class="meter mla"  id="subject-meter"/>
                          </div>
                        </div>
                        <div class="score-column smart y z mt16">
                          <div class="trait-name w6 f15 no-select">Technicality</div>
                          <div class="smart y w120p">
                            <span class="f11 lh24 w5 mr12" id="aesthetic-val">5.00</span>
                            <input type="range" min="0" max="1000" value="500" class="meter mla"  id="aesthetic-meter"/>
                          </div>
                        </div>
                      </div>
                      <div class="note-section iS mt32 pl20 pr20">
              ...
              <div id="" class=" rdx pt20 pb20  rate-tab" style="left: 0; top: 570px">
                <div class="">
                  <h2 class="ml20 f17 w6">Please select the best picture below</h2>
                  <div class=" bg-white gp50 gg0">
                    <img src="assets/hughe.jpg" class="mat w100 v">
                    <img src="assets/s2.jpg" class="mat w100 v">
                  </div>
                  <div class="  bsbx ">
                    <div class="panel-mobile-inner">
                      <div class="note-section iS mt32 pl20 pr20">
              ...
              <div id="" class=" rdx pt20 pb20  rate-tab" style="left: -400px;top: 0">
                <div class="">
                  <h2 class="ml20 f17 w6">Please rate the image below</h2>
                  <div class=" bg-white">
                    <img src="assets/peakwoman.jpg" class="mat mt30 mb30 w100 v">
                  </div>
                  <div class="  bsbx ">
                    <div class="panel-mobile-inner">
                      <div class="score-row score-row-traits clearfix pl20 pr20">
                        <div class="score-column smart y z">
                          <span class="trait-name w6 f15 no-select">Composition</span>
                          <div class="smart y w120p">
                            <span class="f11 lh24 w5 mr12" id="composition-val">5.00</span>
                            <input type="range" min="0" max="1000" value="500"  class="meter mla"  id="composition-meter"/>
                          </div>
                        ...
                        <div class="score-column smart y z mt16">
                          <div class="trait-name w6 f15 no-select">Subject</div>
                          <div class="smart y w120p">
                            <span class="f11 lh24 w5 mr12" id="subject-val">5.00</span>
                            <input type="range" min="0" max="1000" value="500"  class="meter mla"  id="subject-meter"/>
                          </div>
                        ...
                        <div class="score-column smart y z mt16">
                          <div class="trait-name w6 f15 no-select">Aesthetic</div>
                          <div class="smart y w120p">
                            <span class="f11 lh24 w5 mr12" id="aesthetic-val">5.00</span>
                            <input type="range" min="0" max="1000" value="500" class="meter mla"  id="aesthetic-meter"/>
                          </div>
              ...
              <div id="" class=" rdx pt20 pb20  rate-tab" style="left: 800px;top: -100px">
                <div class="">
                  <h2 class="ml20 f17 w6">Please rate the image below</h2>
                  <div class=" bg-white">
                    <img src="assets/sand.jpg" class="mat mt30 mb30 w100 v">
                  </div>
                  <div class="  bsbx ">
                    <div class="panel-mobile-inner">
                      <div class="score-row score-row-traits clearfix pl20 pr20">
              ...
              <div id="" class=" rdx pt20 pb20  rate-tab" style="left: 800px; top: 600px">
                <div class="">
                  <h2 class="ml20 f17 w6">Please select the best picture below</h2>
                  <div class=" bg-white gp50 gg0">
                    <img src="assets/s0.jpg" class="mat w100 v">
                    <img src="assets/s1.jpg" class="mat w100 v">
                  </div>
                  <div class="  bsbx ">
                    <div class="panel-mobile-inner">
                      <div class="note-section iS mt32 pl20 pr20">
              ...
              <div id="" class=" rdx pt20 pb20  rate-tab" style="left: 1200px;top: 0">
                <div class="">
                  <h2 class="ml20 f17 w6">Please rate the image below</h2>
                  <div class=" bg-white">
                    <img src="assets/karen.jpg" class="mat mt30 mb30 w100 v">
                  </div>
                  <div class="  bsbx ">
                    <div class="panel-mobile-inner">
                      <div class="score-row score-row-traits clearfix pl20 pr20">
                        <div class="score-column smart y z">
                          <span class="trait-name w6 f15 no-select">Noticeability</span>
                          <div class="smart y w120p">
                            <span class="f11 lh24 w5 mr12" id="composition-val">5.00</span>
                            <input type="range" min="0" max="1000" value="500"  class="meter mla"  id="composition-meter"/>
                          </div>
                        ...
                        <div class="score-column smart y z mt16">
                          <div class="trait-name w6 f15 no-select">Attractiveness</div>
                          <div class="smart y w120p">
                            <span class="f11 lh24 w5 mr12" id="subject-val">5.00</span>
                            <input type="range" min="0" max="1000" value="500"  class="meter mla"  id="subject-meter"/>
                          </div>
                        ...
                        <div class="score-column smart y z mt16">
                          <div class="trait-name w6 f15 no-select">Relatability</div>
                          <div class="smart y w120p">
                            <span class="f11 lh24 w5 mr12" id="aesthetic-val">5.00</span>
                            <input type="range" min="0" max="1000" value="500" class="meter mla"  id="aesthetic-meter"/>
                          </div>
              ...
              <div id="" class=" rdx pt20 pb20  rate-tab" style="left: 1600px;top: -10px">
                <div class="">
                  <h2 class="ml20 f17 w6">Please rate the image below</h2>
                  <div class=" bg-white">
                    <img src="assets/aub.jpg" class="mat mt30 mb30 w100 v">
                  </div>
                  <div class="  bsbx ">
                    <div class="panel-mobile-inner">
                      <div class="score-row score-row-traits clearfix pl20 pr20">
...
<div class="y w  " style="position: absolute;left: 0; width: 960px;
...
">
          ...
          <div class="pb20 ml20 mt20 bxbox">
            <a class="rel pointer imgsec">
              <img src="assets/peyto.jpg">
            </a>
            <div class="pl20 pr20">
            <div class="y z mt22">
              <span class="f15 w6">Editing</span>
              <span class="f15 w5">21 Votes</span>
            </div>
            <span class="meter mt16"><span class="ind" style="background: #5983fc;width: 61%"></span></span>
            <div class="y z mt5">
              <h5 class="w6 f13 lh20 m0">Artistry</h5>
              <span class="f11 lh20 w5">6.125</span>
            </div>
            <span class="meter mt10"><span class="ind pur" style="background: #3e60c1;width: 66%"></span></span>
            <div class="y z mt5">
              <h5 class="w6 f13 lh20 m0">Coloration</h5>
              <span class="f11 lh20 w5">6.554</span>
            </div>
            <span class="meter mt10"><span class="ind" style="background: #2e4583; width: 72%"></span></span>
            <div class="y z mt5">
              <h5 class="w6 f13 lh20 m0">Technicality</h5>
              <span class="f11 lh20 w5">7.214</span>
            </div>
            <div class="y z mt20">
              <span class="f15">2 comments</span>
            </div>
          </div>
          </div>
          ...
          <div class="pb20 ml20 mt20 bxbox">
            <a class="rel pointer imgsec">
              <img src="assets/calla@2x.jpg">
            </a>
            <div class="pl20 pr20">
            <div class="y z mt22">
              <span class="f15 w6">Photography</span>
              <span class="f15 w5">35 Votes</span>
            </div>
            <span class="meter mt16"><span class="ind" style="background: #5983fc"></span></span>
            <div class="y z mt5">
              <h5 class="w6 f13 lh20 m0">Composition</h5>
              <span class="f11 lh20 w5">4.323</span>
            </div>
            <span class="meter mt10"><span class="ind pur" style="background: #3e60c1; width: 67%"></span></span>
            <div class="y z mt5">
              <h5 class="w6 f13 lh20 m0">Subject</h5>
              <span class="f11 lh20 w5">6.685</span>
            </div>
            <span class="meter mt10"><span class="ind" style="background: #2e4583;width: 76%"></span></span>
            <div class="y z mt5">
              <h5 class="w6 f13 lh20 m0">Aesthetic</h5>
              <span class="f11 lh20 w5">7.653</span>
            </div>
            <div class="y z mt20">
              <span class="f15">4 comments</span>
            </div>
          </div>
          </div>
          ...
          <div class="pb20 ml20 mt20 bxbox">
            <a class="rel pointer imgsec">
              <img src="assets/norge@2x.jpg">
            </a>
            <div class="pl20 pr20">
            <div class="y z mt22">
              <span class="f15 w6">Editing</span>
              <span class="f15 w5">75 Votes</span>
            </div>
            <span class="meter mt16"><span class="ind" style="background: #5983fc;width: 77%"></span></span>
            <div class="y z mt5">
              <h5 class="w6 f13 lh20 m0">Artistry</h5>
              <span class="f11 lh20 w5">7.685</span>
            </div>
            <span class="meter mt10"><span class="ind pur" style="background: #3e60c1;width: 89%"></span></span>
            <div class="y z mt5">
              <h5 class="w6 f13 lh20 m0">Coloration</h5>
              <span class="f11 lh20 w5">8.879</span>
            </div>
            <span class="meter mt10"><span class="ind" style="background: #2e4583; width: 72%"></span></span>
            <div class="y z mt5">
              <h5 class="w6 f13 lh20 m0">Technicality</h5>
              <span class="f11 lh20 w5">7.243</span>
            </div>
            <div class="y z mt20">
              <span class="f15">11 comments</span>
            </div>
          </div>
          </div>
          ...
          <div class="w50 w100-lg pb32 mla">

            <div class=" w home-swap mt60 mb96  ">
              <h3 class="w6 big mb0 mt1 f45">Find your best pictures.</h3>
              <p class=" f15 mt24 w5 txt-rr ">Get critiques and input on the best pictures of your portfolio, and make them better.</p>
            </div>

            <ul class="L  gg20  mt48 " >
              <li class="gp50 y">

                <!-- Generator: Adobe Illustrator 24.2.3, SVG Export Plug-In  -->
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="36px"
   height="36px" viewBox="0 0 36 36" style="overflow:visible;enable-background:new 0 0 36 36;" xml:space="preserve" class="mt12">
<g>
  <path class="st0" d="M27.3,36H8.7C3.9,36,0,32.1,0,27.3V8.7C0,3.9,3.9,0,8.7,0h18.7C32.1,0,36,3.9,36,8.7v18.7
    C36,32.1,32.1,36,27.3,36z"/>
</g>
<g>
  <path class="st1" d="M9,24h6v-2H9V24z M9,12v2h18v-2H9z M9,19h12v-2H9V19z"/>
</g>
</svg>
                <div class="ml20">
                  <h4 class="f15 mt10 w6  bl-std mt1 f19 mb0">Intuitive UI/UX</h4>
                  <p class="mt16">Machine learning algorithms will detect spammy ratings and discard them..</p>
                </div>
              </li>
              <li class="gp50 y">
...
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="36px"
  ...
  <path class="st0" d="M27.3,36H8.7C3.9,36,0,32.1,0,27.3V8.7C0,3.9,3.9,0,8.7,0h18.7C32.1,0,36,3.9,36,8.7v18.7
    C36,32.1,32.1,36,27.3,36z"/>
  <path class="st1" d="M15.2,10.8V12l1.7,1.7v-2.9h3.3v3.3h-2.9l1.7,1.7h1.2V17l1.7,1.7v-2.9h3.3v3.3h-2.9l1.7,1.7h1.2V22l1.7,1.7
    V10.8c0-0.9-0.8-1.7-1.7-1.7H12.3l1.7,1.7H15.2z M21.9,10.8h3.3v3.3h-3.3V10.8z M9.6,8.5L8.5,9.6l1.7,1.7v12.9
    c0,0.9,0.8,1.7,1.7,1.7h12.9l1.7,1.7l1.1-1.1L9.6,8.5z M16.9,17.9l1.2,1.2h-1.2V17.9z M11.8,12.9l1.2,1.2h-1.2V12.9z M15.2,24.2
    h-3.3v-3.3h3.3V24.2z M15.2,19.1h-3.3v-3.3h2.9l0.5,0.5V19.1z M20.2,24.2h-3.3v-3.3h2.9l0.5,0.5V24.2z M21.9,24.2v-1.2l1.2,1.2
    H21.9z"/>
</svg>
                ...
                <div class="ml20">
                  <h4 class="f15 mt10 w6  bl-std mt1 f19 mb0">Percentile scores</h4>
                  <p class="mt16">Get a truly accurate comparison of your pictures by competing against others.</p>
                </div>
              </li>
              <li class="gp50 y">
                <!-- Generator: Adobe Illustrator 24.2.3, SVG Export Plug-In  -->
...
<g>
  <path class="st1" d="M28.7,25l-9.1-9.1c0.9-2.3,0.4-5-1.5-6.9c-2-2-5-2.4-7.4-1.3l4.3,4.3l-3,3l-4.4-4.3C6.4,13,6.9,16,8.9,18.1
    c1.9,1.9,4.6,2.4,6.9,1.5l9.1,9.1c0.4,0.4,1,0.4,1.4,0l2.3-2.3C29.1,26,29.1,25.3,28.7,25z"/>
</g>
</svg>

                <div class="ml20">
                  <h4 class="f15 mt10 w6  bl-std mt1 f19 mb0">Sort everything easily</h4>
                  <p class="mt16">Machine learning algorithms will detect spammy ratings and discard them..</p>
                </div>
              </li>
            </ul>
